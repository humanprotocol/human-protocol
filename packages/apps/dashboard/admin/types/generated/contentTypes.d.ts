...
export interface ApiMonthlyTaskSummaryMonthlyTaskSummary extends Schema.CollectionType {
  ...
  info: {
    singularName: 'monthly-task-summary';
    pluralName: 'monthly-task-summaries';
    displayName: 'MonthlyTaskSummary';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::monthly-task-summary.monthly-task-summary', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::monthly-task-summary.monthly-task-summary', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}

export interface ApiNetworkDataItemNetworkDataItem extends Schema.CollectionType {
  collectionName: 'network_data_items';
  info: {
    singularName: 'network-data-item';
    pluralName: 'network-data-items';
    displayName: 'NetworkDataItem';
  };
  options: {
    draftAndPublish: false;
    comment: '';
  ...
  attributes: {
    ...
    dailyHMTData: Attribute.JSON;
    dailyPaymentsData: Attribute.JSON;
    totalTransferAmount: Attribute.String;
    totalTransferCount: Attribute.Integer;
    totalHolders: Attribute.Integer;
    totalSupply: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::network-data-item.network-data-item', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::network-data-item.network-data-item', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}

export interface ApiNewsItemNewsItem extends Schema.SingleType {
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<'api::news-item.news-item', 'oneToOne', 'admin::user'> & Attribute.Private;
    updatedBy: Attribute.Relation<'api::news-item.news-item', 'oneToOne', 'admin::user'> & Attribute.Private;
  };
}
