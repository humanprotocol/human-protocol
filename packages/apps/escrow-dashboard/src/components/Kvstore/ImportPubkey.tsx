...
async function getGithubGPGFile(username:string,setError: Dispatch<string>,setKey: Dispatch<Key>,setPage: Dispatch<number>,setStep: Dispatch<number>){
    try{
...
//        const a=await readKey({armoredKey:gpg});
//        if(a.isPrivate()){
//            setError("Error, user doesn't have any public key");
//            return
//        }
      ...
      <Grid container direction="column">
        ...
        >
            ...
            {choose==="github" && <><Typography  variant="body2" color="primary">
                ...
                <Grid container justifyContent="center">
                    <Button variant="outlined" onClick={()=>getGithubGPGFile(username,setError,setKey,setPage,setStep)} sx={{ mx: 2, mt: 2 }}>
                Get public key
                </Button>
                </Grid>
                <Grid container justifyContent="center">
