...
import { useTableQuery } from '@/shared/components/ui/table/table-query-hook';
import type { Person } from '@/modules/playground/components/table-example/table-service';
import { getTableData } from '@/modules/playground/components/table-example/table-service';
import { SearchForm } from '@/modules/playground/components/table-example/table-search-form';
