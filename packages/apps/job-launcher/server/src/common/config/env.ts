...
export const ConfigNames = {
  ...
  HCAPTCHA_RECORDING_ORACLE_ADDRESS: 'HCAPTCHA_RECORDING_ORACLE_ADDRESS',
  HCAPTCHA_REPUTATION_ORACLE_ADDRESS: 'HCAPTCHA_REPUTATION_ORACLE_ADDRESS',
...
export const envValidator = Joi.object({
  ...
  HCAPTCHA_REPUTATION_ORACLE_ADDRESS: Joi.string().required(),
