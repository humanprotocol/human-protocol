...
export class ExchangeApiKeys1761295918414 implements MigrationInterface {
  name = 'ExchangeApiKeys1761295918414';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_8dcd9d18790ca62ebf1fb40cd3" ON "hmt"."exchange_api_keys" ("user_id", "exchange_name") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "hmt"."IDX_8dcd9d18790ca62ebf1fb40cd3"`,
    );
