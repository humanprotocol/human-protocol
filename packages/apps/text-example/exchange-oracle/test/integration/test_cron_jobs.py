...
class CRONJobTest(unittest.TestCase):
    ...
    def test_process_pending_job_request_failing_due_to_error_in_setting_up_project(self, mock_set_up_projects):
    ...
    @patch("src.cron_jobs.is_done")
    def test_process_in_progress_job_requests_with_partially_completed_project_set(self, mock_is_done: MagicMock):
    ...
    def test_process_completed_job_requests(self, mock_download: MagicMock, mock_delete: MagicMock):
        ...
        with Session() as session:
            ...
            mock_download.assert_any_call(project_id=projects[0].id, job_request_id=projects[0].job_request_id)
    ...
    @patch("src.cron_jobs.delete_project")
    @patch("src.cron_jobs.download_annotations")
    def test_process_completed_job_requests_failing_partially_due_to_failing_project_processing(self, mock_download: MagicMock, mock_delete: MagicMock):
        ...
        with Session() as session:
            ...
            mock_download.assert_any_call(project_id=projects[-1].id, job_request_id=projects[-1].job_request_id)
