...
def create_task(escrow_address: str, chain_id: int) -> None:
    ...
    if manifest.annotation.type is TaskTypes.image_boxes:
        builder_type = BoxesTaskBuilder
    elif manifest.annotation.type is TaskTypes.image_label_binary:
    ...
    elif manifest.annotation.type is TaskTypes.audio_transcription:
