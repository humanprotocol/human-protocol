...
#         )
#         self.assertEqual(updated_webhook.status,
#                          OracleWebhookStatuses.completed.value)
...
#         self.assertEqual(updated_webhook.status,
#                          OracleWebhookStatuses.pending.value)
#         self.assertEqual(updated_webhook.attempts, 1)
#         self.assertEqual(
#             cm.output,
#             [
...
#         mock_cvat_api.create_cloudstorage.side_effect = Exception(
#             "Connection error")
#         chain_id = Networks.localhost.value
#         escrow_address = create_escrow(self.w3)
#         fund_escrow(self.w3, escrow_address)
...
#         mock_cvat_api.create_cloudstorage.return_value.id = 1
#         mock_cvat_api.create_project.side_effect = Exception(
#             "Connection error")
#         chain_id = Networks.localhost.value
#         escrow_address = create_escrow(self.w3)
#         fund_escrow(self.w3, escrow_address)
...
#         mock_create_cvat_api.create_task.side_effect = Exception(
#             "Connection error")
#         chain_id = Networks.localhost.value
#         escrow_address = create_escrow(self.w3)
#         fund_escrow(self.w3, escrow_address)
