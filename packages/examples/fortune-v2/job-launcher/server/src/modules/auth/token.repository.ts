...
export class TokenRepository {
  ...
  public async findOne(where: FindConditions<TokenEntity>): Promise<TokenEntity | undefined> {
    const tokenEntity = await this.tokenEntityRepository.findOne({ where, relations: ["user"] });
