...
import { JobCreateDto, JobCvatCreateDto, JobFortuneCreateDto, JobUpdateDto } from "./job.dto";
...
export class JobRepository {
  ...
  public async findOne(
    ...
    const jobEntity = await this.jobEntityRepository.findOne({ where, ...options });
  ...
  public async create(dto: JobCreateDto): Promise<JobEntity> {
    return this.jobEntityRepository
      .create(dto)
      .save();
  }
}
