...
dotenv.config({ path: path.join(__dirname, process.env.DOCKER ? './.env.docker' : './.env') });
...
const addresses = {
    ...
    recOracle: process.env.REC_ORACLE_ADDRESS || '0x70997970C51812dc3A010C7d01b50e0d17dc79C8',
    repOracle: process.env.REP_ORACLE_ADDRESS || '0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC',
    exchangeOracle: process.env.EXCHANGE_ORACLE_ADDRESS || '0x6b7E3C31F34cF38d1DFC1D9A8A59482028395809',
};
