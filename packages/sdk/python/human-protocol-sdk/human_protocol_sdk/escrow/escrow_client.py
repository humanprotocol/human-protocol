...
class EscrowCancel:
    def __init__(self, tx_hash: str, amount_refunded: any):
        ...
        Args:
            tx_hash: The hash of the transaction that cancelled the escrow.
            amount_refunded: The amount refunded during the escrow cancellation.
        """
        self.txHash = tx_hash
...
class EscrowWithdraw:
    def __init__(self, tx_hash: str, token_address: str, withdrawn_amount: any):
        ...
        Args:
            tx_hash: The hash of the transaction associated with the escrow withdrawal.
            token_address: The address of the token used for the withdrawal.
            withdrawn_amount: The amount withdrawn from the escrow.
        """
        self.txHash = tx_hash
...
class EscrowConfig:
    ...
    def __init__(
        ...
        """Initializes an EscrowClient instance.

        Args:
            recording_oracle_address: Address of the Recording Oracle
            reputation_oracle_address: Address of the Reputation Oracle
            recording_oracle_fee: Fee percentage of the Recording Oracle
            reputation_oracle_fee: Fee percentage of the Reputation Oracle
            manifest: Manifest data (can be a URL or JSON string)
            hash: Manifest file hash
        """
...
class EscrowClient:
    ...
    def create_escrow(
        ...
        Args:
            token_address: Address of the token to be used in the escrow
            job_requester_id: An off-chain identifier for the job requester
    ...
    def create_fund_and_setup_escrow(
        ...
        Args:
            token_address: Address of the token to be used in the escrow
            amount: The token amount to fund the escrow with
            job_requester_id: An off-chain identifier for the job requester
            escrow_config: Configuration parameters for escrow setup
            tx_options: (Optional) Transaction options
    ...
    def fund(
        ...
        Args:
            escrow_address: Address of the escrow to fund
            amount: Amount to be added as funds
            tx_options: (Optional) Additional transaction parameters
    ...
    def store_results(
        ...
        Args:
            ...
            hash: Results file hash
            funds_to_reserve: (Optional) Funds to reserve for payouts
            tx_options: (Optional) Additional transaction parameters
    ...
    def complete(
        ...
        Args:
            escrow_address: Address of the escrow to complete
            tx_options: (Optional) Additional transaction parameters
    ...
    def bulk_payout(
        ...
        Args:
            ...
            final_results_url: Final results file URL
            final_results_hash: Final results file hash
            payout_id: Payout ID (str) or Transaction ID (int)
            force_complete: (Optional) Whether to force completion
            tx_options: (Optional) Transaction options
    ...
    def create_bulk_payout_transaction(
        ...
        Args:
            ...
            amounts: Array of amounts the recipients will receive
            final_results_url: Final results file URL
            final_results_hash: Final results file hash
    ...
    def request_cancellation(
        ...
        Args:
            escrow_address: Address of the escrow to request cancellation
            tx_options: (Optional) Additional transaction parameters
    ...
    def cancel(
        ...
        Args:
            escrow_address: Address of the escrow to cancel
            tx_options: (Optional) Additional transaction parameters

        Returns:
            An instance of the EscrowCancel class containing details of the cancellation transaction, including the transaction hash and the amount refunded.
    ...
    def withdraw(
        ...
        Args:
            escrow_address: Address of the escrow to withdraw
            token_address: Address of the token to withdraw
            tx_options: (Optional) Additional transaction parameters

        Returns:
            An instance of the EscrowWithdraw class containing details of the withdrawal transaction, including the transaction hash and the token address and amount withdrawn.

        Raises:
            EscrowClientError: If an error occurs while checking the parameters
            EscrowClientError: If the transfer event associated with the withdrawal is not found in the transaction logs
    ...
    def _get_escrow_contract(self, address: str) -> contract.Contract:
        ...
        Args:
            escrow_address: Address of the deployed escrow
