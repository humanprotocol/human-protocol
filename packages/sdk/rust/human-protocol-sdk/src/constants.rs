...
pub struct Network {
    ...
    pub reward_pool_address: &'static str,
...
lazy_static! {
    ...
    pub static ref NETWORKS: std::collections::HashMap<ChainId, Network> = map![
        ...
        ChainId::AvalancheTestnet => Network {
            title: "Fuji C-Chain",
    ...
    pub static ref KV_STORE_KEYS: std::collections::HashMap<String, String> = map![
        ...
        "webhookUrl".to_string() => "webhookUrl".to_string(),
